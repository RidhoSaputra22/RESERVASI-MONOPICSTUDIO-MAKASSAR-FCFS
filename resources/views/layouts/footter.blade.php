...
<section class=" bg-primary   px-10 text-white">
    <div class="flex py-10">
        <div class="flex-1">
            <div class="flex items-center gap-2">
                <div class="space-y-2   ">
                    <h1 class="text-3xl font-semibold">Monopic Studio</h1>
    ...
    <div class="py-3 flex border-t border-white text-sm font-light">
        <div class="flex-1">
            &copy; 2025 Monopic Studio Makassar - Universitas Dipanegara Makassar
        </div>
