<div>
    <section class="min-h-screen w-full max-w-7xl mx-auto min-h-screen p-24 space-y-14 text-primary">
        ...
        <div class="w-full divide-y divide-outline text-on-surface dark:divide-outline-dark dark:text-on-surface-dark"
            ...
            <div x-data="{ isExpanded: false }">
                ...
                <div x-cloak x-show="isExpanded" id="accordionItemOne" role="region"
                    ...
                    <div class="pb-4 text-sm sm:text-base text-pretty ">
                        ...
                        photo studio, serta jadwal yang tersedia. Setelah pemesanan dilakukan, Anda akan menerima
                        konfirmasi
            ...
            <div x-data="{ isExpanded: false }">
                ...
                <div x-cloak x-show="isExpanded" id="accordionItemOne" role="region"
                    aria-labelledby="controlsAccordionItemOne" x-collapse>
                    <div class="pb-4 text-sm sm:text-base text-pretty ">
                        Saat ini, perubahan atau pembatalan jadwal belum mendukung fitur rescheduling. Setiap pemesanan
                        yang telah dikonfirmasi tidak dapat dijadwalkan ulang. Untuk pembatalan, Anda dapat mengajukan
                        permintaan melalui sistem atau menghubungi tim kami, dan status permintaan akan diinformasikan
                        secara transparan melalui notifikasi sesuai ketentuan yang berlaku.
                    </div>
                </div>
            </div>
            <div x-data="{ isExpanded: false }">
                ...
                <div x-cloak x-show="isExpanded" id="accordionItemOne" role="region"
                    ...
                    <div class="pb-4 text-sm sm:text-base text-pretty ">
                        ...
                        serta sesi photo studio lainnya. Setiap layanan tersedia dalam beberapa paket yang dapat
                        disesuaikan
            ...
            <div x-data="{ isExpanded: false }">
                ...
                <div x-cloak x-show="isExpanded" id="accordionItemOne" role="region"
                    ...
                    <div class="pb-4 text-sm sm:text-base text-pretty ">
                        ...
                        pengiriman akan diinformasikan sejak awal pemesanan agar Anda mendapatkan kejelasan dan
                        kepastian.
                    </div>
                </div>
            </div>
            <div x-data="{ isExpanded: false }">
                ...
                <div x-cloak x-show="isExpanded" id="accordionItemOne" role="region"
                    ...
                    <div class="pb-4 text-sm sm:text-base text-pretty ">
                        ...
                        Monopic Studio. Tim kami siap membantu dan memberikan informasi yang Anda butuhkan dengan
                        respons
